import{It as e,Mt as t,Sr as n,_r as r,fr as i,lr as a,p as o,xr as s}from"./three.core-BoMSk3Jx.js";var c=`
...
`,u=315;function d(){let e=document.createElement(`canvas`);e.width=256,e.height=256;let t=e.getContext(`2d`),n=t.createRadialGradient(128,128,2,128,128,128);n.addColorStop(0,`rgba(255,253,238,1)`),n.addColorStop(.08,`rgba(255,248,220,1)`),n.addColorStop(.2,`rgba(255,221,154,0.50)`),n.addColorStop(.5,`rgba(255,181,92,0.12)`),n.addColorStop(1,`rgba(255,160,65,0)`),t.fillStyle=n,t.fillRect(0,0,256,256);let r=new o(e);return r.colorSpace=a,r}function f(a,o){let f={uTime:{value:0},uSunDirection:{value:o},uUnderwater:{value:0},uSunVisibility:{value:1}},p=new i({side:1,depthWrite:!1,fog:!1,uniforms:f,vertexShader:c,fragmentShader:l}),m=new e(new r(390,48,24),p);m.renderOrder=-10,a.add(m);let h=new n({map:d(),color:16773583,transparent:!0,opacity:.78,depthWrite:!1,depthTest:!0,blending:2,toneMapped:!1,fog:!1}),g=new s(h);return g.scale.set(14,14,1),g.renderOrder=-5,a.add(g),{sky:m,sun:g,uniforms:f,update(e,n,r){f.uTime.value=e,f.uUnderwater.value=n,h.opacity=t.lerp(.78,.04,n),m.position.copy(r.position),g.position.copy(r.position).addScaledVector(o,u)}}}export{f as createSky};